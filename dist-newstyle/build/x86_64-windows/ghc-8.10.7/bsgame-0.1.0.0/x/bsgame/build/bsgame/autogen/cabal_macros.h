...
/* package bsgame-0.1.0.0 */
#ifndef VERSION_bsgame
#define VERSION_bsgame "0.1.0.0"
#endif /* VERSION_bsgame */
#ifndef MIN_VERSION_bsgame
#define MIN_VERSION_bsgame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bsgame */
...
#define CURRENT_COMPONENT_ID "bsgame-0.1.0.0-inplace-bsgame"
